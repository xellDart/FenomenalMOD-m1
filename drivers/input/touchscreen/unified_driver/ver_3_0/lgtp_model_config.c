...
struct of_device_id  Sn280h_MatchTable[2] = {{ .compatible = "unified_driver_ver2,sn280h", },};
#endif
...
#if defined(TOUCH_MODEL_E1)
static void TouchPowerVioE1(int isOn)
{
	static struct regulator *vdd_io;
	int error = 0;
...
static void TouchPowerVddE1(int isOn)
{
...
void TouchPowerModel(int isOn)
{
	...
	TouchPowerVddE1(isOn);
	TouchPowerVioE1(isOn);
...
{
	#if defined(TOUCH_MODEL_Y30) || defined(TOUCH_MODEL_E1)
