...
static uint16_t isFirstStream = FALSE; /*LGE_CHANGE, check first stream. , 2015-04-20, sangwoo25.park@lge.com */
...
/*LGE_CHANGE_E, fixed Fps setting of soc sensor for VT mode, 2014-01-27, dongsu.bag@lge.com*/
	default:
		rc = 0; //-EFAULT;  /* LGE_CHANGE, Not support config, 2015-6-12, jonghwan.ko@lge.com */
